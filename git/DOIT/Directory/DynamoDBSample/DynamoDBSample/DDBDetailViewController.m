...
- (void)getTableRow:(NSString *)rangeKey {
    ...
    [[dynamoDBObjectMapper load:[DDBTableRow class]
        ...
        if (!task.error) {
            ...
            self.attribute1TextField.text = tableRow.address;
            self.attribute2TextField.text = tableRow.main;
            self.attribute3TextField.text = tableRow.fax;
        } else {
...
- (IBAction)submit:(id)sender {
    ...
    tableRow.address = self.attribute1TextField.text;
    tableRow.main = self.attribute2TextField.text;
    tableRow.fax = self.attribute3TextField.text;
